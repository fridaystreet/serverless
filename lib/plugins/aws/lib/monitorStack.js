...
module.exports = {
  monitorStack(action, cfData, monitoredSince, frequency) {
            ...
            return this.provider.request('CloudFormation',
              ...
              .then((data) => {
                ...
                data.StackEvents.reverse().forEach((event) => {
                  console.log(monitoredSince, event.Timestamp);
                  console.log('logged', loggedEvents.indexOf(event.EventId));
                  console.log('event.status', event.ResourceStatus);
